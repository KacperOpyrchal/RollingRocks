...
public class GameStageOldVersion extends Stage {
    ...
    public GameStageOldVersion(Viewport viewport, Batch batch) {
...
*/
   ...
   public void loadMap() {
        mapGenerator = new MapGenerator();
        addPlayer(mapGenerator.getPlayer());

        Obstacle[] array = mapGenerator.getObstacles();
